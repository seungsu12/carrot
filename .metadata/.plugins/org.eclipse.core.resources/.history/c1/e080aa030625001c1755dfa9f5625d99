...
<body>
				...
				<div class="order_main_input_wrapper order_main_content">
					<div class="order_main_input">
						...
						<input class="order_email" id="order_eamil" type="email" name="email" placeholder="이메일">
						<span class="order_inform_text order_email_inform_text"></span>	
					</div>
					<div class="order_main_input">
						<label for="order_phone">전화번호</label><br>
						<input class="order_phone" id="order_phone" type="tel" name="phone" placeholder="전화번호">
