 ...
 * Generated at: 2021-10-24 05:15:13 UTC
...
public final class orderform_005fsecond_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		margin-top : 1rem;\n");
      out.write("	}\n");
      out.write("	.order_member_info div{\n");
      out.write("		margin-left: 0.5rem;\n");
      out.write("	}\n");
      out.write("	.order_member_info2{\n");
      out.write("		display :none;\n");
      ...
      out.write("		\n");
      out.write("	}\n");
      out.write("	.order_member_info2 input{\n");
      out.write("		padding : 0.5rem;\n");
      out.write("		width : 14rem;\n");
      out.write("	}\n");
      out.write("	.order_member_correction_button{\n");
      out.write("		margin-left : 2rem;\n");
      out.write("		height :100%;\n");
      out.write("		width : 5rem;\n");
      out.write("		font-size : 1rem;\n");
      out.write("	}\n");
      out.write("	.order_member_input_wrapper{\n");
      out.write("		display: flex;\n");
      out.write("		flex-direction :column;\n");
      out.write("		row-gap : 0.4rem;\n");
      out.write("	}\n");
      out.write("	.order_member_info2 i{\n");
      out.write("		float : right\n");
      out.write("	}\n");
      out.write("	.order_member_info2 div:nth-child(3){\n");
      ...
      out.write("		<div class=\"order_member_info long\">\n");
      out.write("			<div class=\"order_member_email\">");
      ...
      out.write("</div>\n");
      out.write("			<div class=\"order_member_phone\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${memberVO.phone_num }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("</div>\n");
      out.write("			<div class=\"order_member_open_button\"><i class=\"fas fa-plus open_info\"></i></div>\n");
      out.write("		</div>\n");
      out.write("		<div class=\"order_member_info2 long\">\n");
      out.write("			<div class=\"order_member_input_wrapper\">\n");
      out.write("				<div><input id=\"second_member_email\" type=\"text\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${memberVO.email }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"></div>\n");
      out.write("				<div><input id=\"second_member_phone\" type=\"text\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${memberVO.phone_num }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"></div>\n");
      out.write("			</div>\n");
      out.write("			<div><button class=\"order_member_correction_button\">수정</button></div>\n");
      out.write("			<div class=\"order_member_close_button\"><i class=\"fas fa-minus close_info\"></i></div>\n");
      out.write("		</div>\n");
      ...
      out.write("			<input type=\"hidden\" name=\"orderform_type\" value=\"2\">\n");
      out.write("		\n");
      ...
      out.write("				<button class=\"order_form_second_button\" type=\"submit\">다음 단계 진행</button>\n");
      out.write("			</div>\n");
      out.write("\n");
      out.write("		</form>\n");
      out.write("	</div>\n");
      ...
      out.write("        }).open();\n");
      out.write("    }\n");
      out.write("	// 멤버 이메일,휴대폰 정보 디스플레이\n");
      out.write("	/* const origin_wrap = document.querySelector('.order_member_info');\n");
      out.write("	const second_wrap = document.querySelector('.order_member_info2');\n");
      out.write("	\n");
      out.write("	document.querySelector('.open_info').addEventListener('click',() =>{\n");
      out.write("		origin_wrap.style.display = 'none';\n");
      out.write("		second_wrap.style.display = 'flex';\n");
      out.write("	});\n");
      out.write("	\n");
      out.write("	document.querySelector('.close_info').addEventListener('click', () =>{\n");
      out.write("		origin_wrap.style.display = 'flex';\n");
      out.write("		second_wrap.style.display = 'none';\n");
      out.write("	}); */\n");
      out.write("	\n");
      out.write("	// 멤버 정보 수정 비동기 통신\n");
      out.write("	 function correction(){\n");
      out.write("		const email = document.getElementById('second_member_email');\n");
      out.write("		const phone = document.getElementById('second_member_phone');\n");
      out.write("		const path = '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("'+'/orderform';\n");
      out.write("		const info = {email : email, phone : phone};\n");
      out.write("		 fetch(path,{\n");
      out.write("			method :'put',\n");
      out.write("			body: JSON.stringify(info)\n");
      out.write("		})\n");
      out.write("		.then(res){\n");
      ...
      out.write("		\n");
      out.write("	} \n");
      out.write("	//member_info open,close\n");
      out.write("	\n");
      out.write("	document.querySelector('.order_member_open_button').addEventListener('click', ()=>{\n");
      out.write("			document.querySelector('.order_member_info').style.display = 'none';\n");
      out.write("			document.querySelector('.order_member_info2').style.display ='flex';\n");
      out.write("		});\n");
      out.write(" 	document.querySelector('.order_member_close_button').addEventListener('click',()=>{\n");
      out.write(" 		document.querySelector('.order_member_info').style.display = 'flex';\n");
      out.write("		document.querySelector('.order_member_info2').style.display ='none';	 		\n");
      out.write(" 	})\n");
      out.write("\n");
      out.write("	</script>\n");
      out.write("</html>");
