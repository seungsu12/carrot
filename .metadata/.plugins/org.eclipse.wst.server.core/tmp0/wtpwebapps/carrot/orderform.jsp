	...
	<div class="order_form_wrapper">
			...
			<div class="order_main order_main_content">
				...
				<div class="order_main_input_wrapper order_main_content">
					<div class="order_main_input">
						...
						<input id="order_eamil" type="email" name="email" placeholder="이메일">	
					</div>
					<div class="order_main_input">
						<label for="order_phone">전화번호</label><br>
						<input id="order_phone" type="tel" name="phone" placeholder="전화번호">
					</div>
				</div>
		...
		2. 이 약관에서 정하지 아니한 내용과 이 약관의 해석에 관하여는 전자상거래 등에서의 소비자보호에 관한 법률, 약관의 규제 등에 관한 법률, 공정거래위원 회가 정하는 전자상거래 등에서의 소비자보호지침 및 관계법령 또는 상관례에 따릅니다
				...
				<div class="order_submit_wrapper order_main_content">
					<input class="order_submit_button" type="button" value="다음단계 진행">
				</div>
			</div>
			...
			<div class="order_aside">
				...
				<div class="order_aside_content">
					...
					<div class="order_aside_content_text">
						<div class="order_aside_content_text_title">나이키 월플</div>
						<div class="order_aside_content_text_code">상품 코드</div>
						<div class="order_aside_content_text_size">사이즈 : 250</div>
						<div class="order_aside_content_text_count">수량 1개</div>
						<div class="order_aisde_content_text_price">55200원</div>
					</div>
				</div>
				<div class="order_aside_bottom">
						...
						<div class="order_aside_bottom_content order_aside_bottom_content2">
							<div>총 결제금액</div>
							<div class="order_aside_bottom_content_price">55200원</div>
						</div>
	...
	<script>
		...
		checkbox.addEventListener('click',() =>{
			...
			if(checkbox.checked){
				...
				submit_button.classList.add("order_submit_button_checked");
				submit_button.classList.remove("order_submit_button");
			}else{
				console.log('check disable');
				submit_button.classList.add("order_submit_button");
				submit_button.classList.remove("order_submit_button_checked");
			}
		})
	</script>
</body>
